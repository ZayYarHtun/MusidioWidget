...
class Log {
    static let musidioEngine = "com.mobdio.MusidioEngine"
    static var network = Logger(subsystem: musidioEngine, category: "Network")
    static var player = Logger(subsystem: musidioEngine, category: "Player")
